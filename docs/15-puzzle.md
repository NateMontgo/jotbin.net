...
This project always brings me so much joy to return to. I am still proud of how this project turned out. If I were to take a second stab at this project, I definitely would have taken a mobile-first approach, and I would have been more intentional about how I organized my code. I also probably would have found a better library to use for playing sounds to resolve those mobile issues I mentioned in the later half of my commentary. This project never did end up getting bought by any web game hosting sites, but I am very proud nonetheless.